<template>
  ...
  <img
    ...
    :class="['inline-icon', { 'v-icon--disabled': disabled }]"
  ...
  <svg
    v-else
    v-html="rawSvg"
    :class="['inline-icon', { 'v-icon--disabled': disabled }, ...iconClass]"
    :style="[dimensionStyle, inlineStyle]"
    v-bind="attrs"
    :aria-hidden="ariaHidden"
    role="img"
...
const iconClass = computed(() => [
  ...
  {'me-2': props.start, 'ms-2': props.end, 'v-icon--disabled': props.disabled},
])
